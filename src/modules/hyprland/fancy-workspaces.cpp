...
FancyWorkspaces::Workspaces(const std::string& id, const Bar& bar, const Json::Value& config)
...
void FancyWorkspaces::registerOrphanWindow(WindowCreationPayload create_window_payload) {
